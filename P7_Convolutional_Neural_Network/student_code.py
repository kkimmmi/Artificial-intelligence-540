...
class LeNet(nn.Module):
    ...
    def forward(self, x):
        ...
        shape_dict = {}
        # certain operations
        out = nn.functional.max_pool2d(nn.functional.relu(self.conv1(x)), kernel_size=2, stride =2)
        shape_dict[1]=list(out.shape)
        out = nn.functional.max_pool2d(nn.functional.relu(self.conv2(out)), kernel_size=2, stride =2)
